...
path_testing = "D:\\PycharmProjects\\Machine Learning\\PythonMachineLearning\\spoon-vs-fork\\test_spoony"
...
# test_x = read_img(path_testing, None, False)
...
for epoch in range(num_epoch):
    ...
    for i, data in enumerate(train_val_loader):
        model.train()
        optimizer.zero_grad()
        train_pred = model(data[0].cuda())  # 预测的结果
...
#         for y in test_label:
#             prediction.append(y)
# print(sorted(os.listdir(path_testing)))
# print("---")
# print(prediction)
